      ...
      <div className="container max-w-4xl mx-auto z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            {/* NAME */}
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight text-center md:text-left">
              <span className="opacity-0 animate-fade-in animate-fade-in-delay-1"> Hi, I’m </span>
          ...
          {/* RIGHT — TEXT */}
          <div className="space-y-6 text-center md:text-left mt-25">
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground opacity-0 animate-fade-in-delay-3">
              ...
              JavaScript, React Native, Java, and AWS while applying  network principles.
            </p>
