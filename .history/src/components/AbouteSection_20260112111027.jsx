            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        that prioritize performance, scalability, and security using technologies like React,
                        Laravel, Java, and cloud services.
                        </p>

                        <p>
                        I enjoy transforming ideas into well-structured solutions by combining clean code,
                        thoughtful architecture, and a strong understanding of network security principles.
                        </p>
                    </div>
                </div>
            </div>
